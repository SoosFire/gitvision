...
3. **Run `npm run test:run`** — confirm the 180-test suite is green before you start. If red on a fresh checkout, fix that first; don't build on a broken baseline.
